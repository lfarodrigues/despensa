    ...
    public void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == REQUEST_CODE_PRODUCT_REGISTRATION && resultCode == RESULT_OK) {
            if (data != null) {
                ...
                byte[] imageByteArray = data.getByteArrayExtra("imageByteArray");
                ...
                if (newProduct != null && purchaseDate != null && expirationDate != null && quantity != null && category != null) {
                    UserManager.getInstance().getLogedUser().getProductsList().add(new Product(newProduct, quantity, category, purchaseDate, expirationDate, imageBitmap));
